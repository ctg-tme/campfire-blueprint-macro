...
async function BuildUserInterface(config, devConfig) {
  let orderLocation = '';

  if (typeof order == 'number' && order > 0) {
    orderLocation = `<Order>${order}</Order>`;
  };
  ...
  <Panel>
    ...
    <Page>
      ...
      <Row>
        ...
        <Widget>
          ...
          <ValueSpace>
            <Value>
              <Key>Speaker</Key>
              <Name>${Text.Panel.Page.Mode.Buttons.Speaker.Title}${Text.Panel.Page.Mode.Buttons.Speaker.Emoji}</Name>
            </Value>
            <Value>
              <Key>Everyone</Key>
              <Name>${Text.Panel.Page.Mode.Buttons.Everyone.Title}${Text.Panel.Page.Mode.Buttons.Everyone.Emoji}</Name>
            </Value>
            <Value>
              <Key>Conversation</Key>
              <Name>${Text.Panel.Page.Mode.Buttons.Conversation.Title}${Text.Panel.Page.Mode.Buttons.Conversation.Emoji}</Name>
            </Value>
            <Value>
              <Key>Presenter</Key>
              <Name>${Text.Panel.Page.Mode.Buttons.Presenter.Title}${Text.Panel.Page.Mode.Buttons.Presenter.Emoji}</Name>
            </Value>
            <Value>
              <Key>QuestionAndAnswer</Key>
              <Name>${Text.Panel.Page.Mode.Buttons.QuestionAndAnswer.Title}${Text.Panel.Page.Mode.Buttons.QuestionAndAnswer.Emoji}</Name>
            </Value>
          </ValueSpace>
        </Widget>
      </Row>
      ...
      -->
      <Row>
        <Name>${Text.Panel.Page.Selview.Name}</Name>
        <Widget>
          <WidgetId>Campfire~Blueprint~CameraFeatures~SelfviewShowText</WidgetId>
          <Name>${Text.Panel.Page.Selview.Buttons.Show}</Name>
          <Type>Text</Type>
        ...
        <Widget>
          ...
          <Name>${Text.Panel.Page.Selview.Buttons.Fullscreen}</Name>
          <Type>Text</Type>
          <Options>size=1;fontSize=small;align=center</Options>
        </Widget>
        <Widget>
    ...
    <Page>
      ...
      <Row>
        <Name>Row</Name>
        <Widget>
          <WidgetId>Campfire~Blueprint~About~Row1</WidgetId>
          <Name>The Campfire Blueprint is a custom solution leveraging the Device's xAPI, Macro Editor and UI Extensions Editor to enable 360° conference room view.</Name>
          <Type>Text</Type>
      ...
      <Row>
        <Name>Row</Name>
        <Widget>
          <WidgetId>Campfire~Blueprint~About~Row2</WidgetId>
          <Name>Campfire coordinates multiple systems to act as one unit allowing full visibility of nearly any participant in the space.</Name>
          <Type>Text</Type>
          <Options>size=4;fontSize=small;align=left</Options>
        </Widget>
      </Row>
      <Row>
        <Name>Row</Name>
        <Widget>
          <WidgetId>Campfire~Blueprint~About~Row3</WidgetId>
          <Name>For support, please contact your Local IT/Device Administrator or Vendor Partner.</Name>
          <Type>Text</Type>
          <Options>size=4;fontSize=small;align=left</Options>
        </Widget>
      </Row>
  ...
  return new Promise(async resolve => {
    try {
      xapi.Command.UserInterface.Extensions.Panel.Save({ PanelId: 'Campfire~Blueprint' });
    } catch (e) {
